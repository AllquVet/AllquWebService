...
class GoogleCalendarManager:
    ...
    def _authenticate(self):
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                flow = InstalledAppFlow.from_client_secrets_file("client_secret_369741700153-cc9hkl79q0jpissmdhgurd2tb88pap8j.apps.googleusercontent.com.json", SCOPES)
    ...
    def list_upcoming_events(self, max_results=10):
        ...
        #2024-11-09T22:00:00-05:00 Try prox 5ain6e6don1fntvs4e4b4pefe2
        #2024-11-10T14:00:00-05:00 TryComprobar evento 1os4bhpm3rhm37ktfcq6vthfh0
        return events
    def list_today_events(self, Start_day=None ,End_day=None):
        events_result = self.service.events().list(
            calendarId='primary', timeMin=Start_day, timeMax=End_day, singleEvents=True,
            orderBy='startTime').execute()
        events = events_result.get('items', [])
    ...
    def create_event(self, summary, start_time, end_time, timezone, attendees=None):
        ...
        try:
            ...
            code_calendar=event.get('id')
            return code_calendar
